...
public class AlignDriveInCommandAlgae extends Command {
    ...
    private SwerveRequest.SwerveDriveBrake brake = new SwerveRequest.SwerveDriveBrake();
        ...
        public AlignDriveInCommandAlgae() {
        this.targetDistance = Meters.of(TARGET_DISTANCE);
        this.addRequirements(Subsystems.swerveSubsystem);
    }

    public AlignDriveInCommandAlgae withTargetDistance(Distance distance) {
    ...
    @Override
    public void execute() {
        BSLogger.log("AlignDriveInCommandAlgae", "execute");
        boolean hasTarget = LimelightHelpers.getTV("limelight");
