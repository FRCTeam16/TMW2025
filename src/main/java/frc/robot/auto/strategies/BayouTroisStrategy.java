...
//                runAutoPath(firstDrive),
                ...
                new AlignDriveInCommand(AlignTarget.RIGHT).withResetPoseDuringDrive(false).withTimeout(1.5),
                doScoreSequence(),

                runAutoPath(thirdDrive),
                new AlignDriveInCommand(AlignTarget.LEFT).withResetPoseDuringDrive(false).withTimeout(1.5),
                doScoreSequence(),
